...
Return JSON array: ["skill1","skill2","tool1","language1"]`,
    ...
    // Extract the EXPERIENCE section header lines to help the LLM identify company/title patterns
...
If no valid dated work experience found, return [].`,
    ...
    // Search full text for the EDUCATION section to include verbatim — RAG retrieval alone
    // may pull in chunks that mention universities in other contexts (e.g. guest lecturer).
